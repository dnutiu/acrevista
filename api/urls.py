...
urlpatterns = [
    ...
    url(r'^papers/reviewer/(?P<pk>[0-9]+)/$', journal.AddRemoveReviewerView.as_view(), name="api-papers-reviewer-add"),
    url(r'^papers/no-editor/$', journal.PaperListNoEditorView.as_view(), name="api-papers-no-editor"),
    url(r'^papers/detail/(?P<pk>[0-9]+)/$', journal.PaperDetailView.as_view(), name="api-paper-detail"),
